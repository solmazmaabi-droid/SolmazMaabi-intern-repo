...
### Kanban Board Columns and Their Meaning
...
- **Blocked**  
  Tasks that cannot continue due to dependencies, missing information, or technical issues.

- **Ready for Review**  
  Tasks that are complete and awaiting code review, testing, or approval.

- **Approved / Done**  
  Tasks that have been reviewed, approved, and completed.

These columns represent the lifecycle of a task from idea to completion.
...
- After approval or automated checks, it moves to **Approved / Done**.

The person working on the task is responsible for updating its status to keep the board accurate and up to date.
...
WIP limits encourage completing tasks before starting new ones.
